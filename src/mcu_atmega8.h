...
#define mcu_int_timer1_ovf_enable()   _BS(TIMSK, _BV(TOIE1))
#define mcu_int_timer1_ovf_disable()  _BC(TIMSK, _BV(TOIE1))
#define mcu_int_timer1_ocma_enable()  _BS(TIMSK, _BV(OCIE1A))
#define mcu_int_timer1_ocma_disable() _BC(TIMSK, _BV(OCIE1A))
#define mcu_int_timer1_ocmb_enable()  _BS(TIMSK, _BV(OCIE1B))
#define mcu_int_timer1_ocmb_disable() _BC(TIMSK, _BV(OCIE1B))
